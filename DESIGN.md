...
| 4 | Jul 2026 | ~~NSBE Senator held off site until Oct 2026~~ (superseded by #16) | Match resume; avoid site/resume mismatch |
...
| 14 | Jul 2026 | Personality pass: Currently strip in hero, beyond-the-code line in About, crimson text selection, serif-italic accent word, JN monogram favicon. Also: nav links warmed from muted gray to ink w/ crimson hover; portrait height:auto fix | User feedback that site felt empty/anonymous; touches add authorship without breaking the recruiter-skim discipline |
| 15 | Jul 2026 | Greek networking app (cross-platform iOS/Android, chapter demo end of July) goes in Currently strip, not Projects | No link/result yet; a linkless card weakens the section. Promote to full project card post-demo with screenshots + outcomes |
| 16 | Jul 2026 | NSBE Senator added to About now, replacing Akofena mention; podcast line swapped for Crunchyroll | Supersedes #4. Akofena was never on the resume, so the swap improves site/resume consistency; Senator role already has real work behind it, voiding the original reason to hold. Remaining action: add NSBE to resume |
| 17 | Jul 2026 | Igbo heritage paragraph added to About (before Beyond the code); Tallahassee "stagnant cycle" framing rejected | Heritage story is specific, true, and explains the drive; hometown critique risked reading as contempt for the community his mentoring serves. No dashes per user preference |
| 18 | Jul 2026 | Heritage line swapped from Igbo-specific framing to "Naija no dey carry last" with English gloss | User: the phrase is communal, representing the shared struggle of succeeding; collective meaning outweighs individual specificity |
| 19 | Jul 2026 | Heritage paragraph final form: identity, phrase, translation, family-pride drive. Receipts clause and grind language cut | Receipts already live in paragraphs above; family pride deepens communal meaning; ends on "proud" |
