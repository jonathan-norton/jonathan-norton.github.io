...
- **Meta description:** `Jonathan Norton is a Computer Science senior at Florida State University building AI/ML projects, currently interning at Raymond James. View projects and resume.`
...
**Subline:** `CS senior at Florida State building AI/ML projects — currently interning at Raymond James.`
...
**Currently strip (label + items):** `CURRENTLY` — `Interning on the AI Execution Team at Raymond James` · `Sharpening Python & SQL` · `AfroTech-bound this November`
[Update these items as life moves — this strip is the site's freshness signal.]
...
**Section intro line:** `Machine learning and data work, with code you can read on GitHub.`
...
- **Link:** `View on GitHub →` [→ https://github.com/jonathan-norton]
...
`I'm a Computer Science senior at Florida State University, on track to graduate in Spring 2027. Right now I'm an IT Project Management Intern on the AI Execution Team at Raymond James in St. Petersburg, seeing how AI actually ships inside a Fortune 500 firm.`
...
`Outside the classroom I serve as Historian of the Theta Eta Chapter of Kappa Alpha Psi and as fundraising chair for Akofena, a kinship organization running a Big Brother Little Brother mentoring program on campus. I like building things that work and being useful to the people around me — the projects above are the best proof I can offer of the first part.`

`Beyond the code: I'm developing a cooking content page, and you'll otherwise find me on a soccer pitch, in the gym, or a few episodes deep in a podcast queue.`
...
[Not a full section — the Resume button in nav and hero links to `/resume.pdf` (opens in new tab). No copy needed beyond button labels.]
...
**Footer small print:** `© 2026 Jonathan Norton · Tallahassee / Tampa, FL`
